    ...
    return (
      <div className="card max-w-full rounded-lg overflow-hidden my-4 border border-gray-700">
        ...
        <div className="flex flex-wrap items-center px-6 py-1">
          <span className="py-1 px-2 no-underline rounded-full bg-secondary btn-shadow text-primary font-primary text-xs btn-primary focus:outline-none active:shadow-none mr-2 my-1">
            VueJS
          </span>
          <span className="py-1 px-2 no-underline rounded-full bg-secondary btn-shadow text-primary font-primary text-xs btn-primary focus:outline-none active:shadow-none mr-2 my-1">
            NodeJS
        ...
        <div className="py-4 px-6">
          ...
          <div className="flex items-center mt-2 text-secondary">
            <FontAwesomeIcon icon={faGithub} />
            <span className="px-2 text-sm">
              <button href="#">View Client Code</button>
            </span>
          </div>
        </div>
      </div>
